    ...
    return (
        <form style={style} className="flex items-center  space-x-2 text-gray-700 pl-4 pr-4 relative ml-auto md:ml-0" onSubmit={handleSubmit}>
            ...
            <div className="border-b-2 border-gray-600 focus-within:bg-gray-200 focus-within:border-gray-700 flex">
                <input value={language} onChange={handleChange} className="border-none focus:bg-gray-200 bg-transparent focus:font-semibold rounded-md  p-1 pl-2 pr-2 outline-none w-[100px] lg:w-[200px] font-sans" onFocus={(e)=>{e.target.select()}}/>
                ...
                {
                    dropDownClicked &&
                    <motion.div className={`absolute top-full bg-white shadow-2xl w-full left-0 z-20
