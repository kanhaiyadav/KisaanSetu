...
const Nav = () => {
    ...
    return (
        <div className={`fixed bottom-0 xs:top-0 left-0 z-50 h-[60px] xs:h-screen ${expanded?'w-full':'w-full xs:w-fit'} ${expanded?'bg-transparent xs:bg-[rgba(0,0,0,0.2)]': 'bg-transparent'}`} onClick={() => {
            setExpanded(false);
        }}>
            ...
            >
                ...
                <section className="flex xs:flex-col justify-evenly xs:justify-start gap-5 py-2 xs:py-4 h-full">
                    <NavItem to={'.'} onClick={()=>{setExpanded(false)}}>
                        ...
                        {
                            <span className={`absolute bottom-[-23px] xs:hidden left-[50%] translate-x-[-50%] text-gray-700 overflow-hidden whitespace-nowrap text-[10px]`}>Dashboard</span>
                        }
                    </NavItem>
                    <NavItem to={'products'} onClick={()=>{setExpanded(false)}}>
                        ...
                        {
                            <span className={`absolute bottom-[-23px] xs:hidden left-[50%] translate-x-[-50%] text-gray-700 overflow-hidden whitespace-nowrap text-[10px]`}>Products</span>
                        }
                    </NavItem>
                    <NavItem to={'sales'} onClick={()=>{setExpanded(false)}}>
                        ...
                        {
                            <span className={`absolute bottom-[-23px] xs:hidden left-[50%] translate-x-[-50%] text-gray-700 overflow-hidden whitespace-nowrap text-[10px]`}>Sales</span>
                        }
                    </NavItem>
                    <NavItem to={'sales-analytics'} onClick={()=>{setExpanded(false)}}>
                        ...
                        {
                            <span className={`absolute bottom-[-23px] xs:hidden left-[50%] translate-x-[-50%] text-gray-700 overflow-hidden whitespace-nowrap text-[10px]`}>Analytics</span>
                        }
                    </NavItem>
