...
const DefaultPage = () => {
    ...
    const scroll = ({ scrollOffset, ref }: ScrollProps) => {
        if (ref.current) {
    ...
    return (
        ...
        `} style={{ backgroundPosition: 'center 0px, right 0px' }}>
                <div className="w-fit ml-[20px] xs:ml-[60px] md:ml-[80px] lg:ml-[100px] xl:ml-[150px] mt-[10px] xs:mt-[40px] md:mt-[60px] lg:mt-[70px] xl:mt-[100px]">
                    <h1 id="gr_heading" className="xs:pb-[3px] sm:pb-[10px] font-Playfair_Display text-2xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-primary">Quality</h1>
