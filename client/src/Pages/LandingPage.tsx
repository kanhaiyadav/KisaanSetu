...
const LandingPage = () => {
    return (
        <div id="landing-page" className="bg-[#fdfdfd] w-screen h-dvh overflow-x-hidden overflow-y-scroll bg-[url('/bgCloud.svg')] bg-fixed bg-cover bg-no-repeat">
            <Navbar />
            ...
            <div id='farmer' className={`bg-white min-h-dvh flex flex-col items-center justify-start`}>
                <div className="bg-white w-full h-[250px] bg-[url('/wave4.svg')] bg-cover"></div>
                <Features />
            </div>
            <div id='customer' className={`bg-white min-h-dvh flex flex-col pt-[50px] items-center justify-center`}>
                <Cfeatures />
