                    ...
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-4">
                            <Link to="/" className="flex items-center text-gray-700 font-bold text-xl">
                                <img src={MyIcon} alt='logo' className="h-10 w-10 mr-2" />
                            </Link>
                            <p className=' text-brown font-bold text-3xl'>KisaanSetu</p>
                        </div>
    ...
    <section className="bg-white">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-12 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <button
                type="button"
                className="text-white bg-lightgreen border border-gray-300 font-boldnpm install framer-motion rounded-full text-sm px-8 py-4 me-2 mb-2 hover:bg-white hover:text-gray-600 hover:outline-black hover:outline hover:outline-2 transition-all duration-300"
                >
                Get Started
        </button>
