...
const Step3 = () => {
    ...
    return (
        <Container>
            <Header>
                <h1 className="m-0 font-sans text-2xl font-semibold text-gray-700">
                    Create a new password
                </h1>
                <i className="text-sm font-normal text-gray-500 m-0">
                    This password will be required while login back to your
                    account.
                </i>
            </Header>
            ...
            <Form onSubmit={handleSubmit(onSubmit)} noValidate>
                <div className="w-full relative">
                    ...
                    {!viewPassword ? (
                        <FaRegEyeSlash
                            className="absolute right-4 top-[50%] translate-y-[-50%] text-gray-600 cursor-pointer text-xl"
